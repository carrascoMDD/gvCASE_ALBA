 ...
 * <ul>
 *   <li>{@link es.gva.cit.gvcase.prototipo.rdbms.impl.JoinImpl#getEtiqueta <em>Etiqueta</em>}</li>
 *   <li>{@link es.gva.cit.gvcase.prototipo.rdbms.impl.JoinImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link es.gva.cit.gvcase.prototipo.rdbms.impl.JoinImpl#getView <em>View</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JoinImpl extends ElementImpl implements Join {
	...
	protected EClass eStaticClass() {
		return RdbmsPackage.Literals.JOIN;
	}
...
//		if (etiquetaDeriveOCL == null) { 
			EStructuralFeature eFeature = (EStructuralFeature) RdbmsPackage.eINSTANCE.getJoin().getEAllStructuralFeatures().get(1);
...
System.out.println(anException.getStackTrace());
			throw new RuntimeException( "Join etiqueta", anException);
		}
	...
	public EList getColumns() {
		if (columns == null) {
			columns = new EObjectWithInverseResolvingEList.ManyInverse(Column.class, this, RdbmsPackage.JOIN__COLUMNS, RdbmsPackage.COLUMN__JOINS);
		}
		return columns;
	}
	 ...
	 */
	public View getView() {
		if (eContainerFeatureID != RdbmsPackage.JOIN__VIEW) return null;
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RdbmsPackage.JOIN__VIEW:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return eBasicSetContainer(otherEnd, RdbmsPackage.JOIN__VIEW, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RdbmsPackage.JOIN__VIEW:
				return eBasicSetContainer(null, RdbmsPackage.JOIN__VIEW, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case RdbmsPackage.JOIN__VIEW:
				return eInternalContainer().eInverseRemove(this, RdbmsPackage.VIEW__JOINS, View.class, msgs);
		}
