...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>proinso</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ProinsoExample {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ProinsoPackage.eNS_URI, 
			 ProinsoPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.proinso"));
				Actividad root = ProinsoFactory.eINSTANCE.createActividad();
