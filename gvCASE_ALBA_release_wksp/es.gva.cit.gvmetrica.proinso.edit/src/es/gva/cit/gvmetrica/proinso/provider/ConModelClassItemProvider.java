...
/**
 * This is the item provider adapter for a {@link es.gva.cit.gvmetrica.proinso.ConModelClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConModelClassItemProvider
		...
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProinsoPackage.Literals.CON_MODEL_CLASS__MODEL_CLASS,
				 false,
				 false,
				 false,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			if (fGetPrefShowMetamodelClassChildNode()) {
				childrenFeatures.add(ProinsoPackage.Literals.CON_MODEL_CLASS__MODEL_CLASS);
			}
		}
