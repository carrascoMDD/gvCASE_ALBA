...
/**
 * This is the item provider adapter for a {@link es.gva.cit.gvmetrica.proinso.Producto} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProductoItemProvider
	...
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEsExternoPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProinsoPackage.Literals.PRODUCTO__NOMBRE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProinsoPackage.Literals.PRODUCTO__CODIGO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Es Externo feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEsExternoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Producto_esExterno_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Producto_esExterno_feature", "_UI_Producto_type"),
				 ProinsoPackage.Literals.PRODUCTO__ES_EXTERNO,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Producto)object).getEtiqueta();
