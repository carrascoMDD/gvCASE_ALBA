...
/**
 * This is the item provider adapter for a {@link es.gva.cit.gvmetrica.proinso.Run} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RunItemProvider
		...
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Run_texto_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Run_texto_feature", "_UI_Run_type"),
				 ProinsoPackage.Literals.RUN__TEXTO,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Run)object).getTexto();
