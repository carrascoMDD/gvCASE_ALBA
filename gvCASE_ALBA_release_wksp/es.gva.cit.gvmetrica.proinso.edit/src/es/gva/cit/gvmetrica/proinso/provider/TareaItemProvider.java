...
/**
 * This is the item provider adapter for a {@link es.gva.cit.gvmetrica.proinso.Tarea} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TareaItemProvider
	...
	protected void addCodigoYNombrePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tarea_codigoYNombre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tarea_codigoYNombre_feature", "_UI_Tarea_type"),
				 ProinsoPackage.Literals.TAREA__CODIGO_YNOMBRE,
				 false,
				 false,
				 false,
	...
	protected void addCodigoCompletoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tarea_codigoCompleto_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tarea_codigoCompleto_feature", "_UI_Tarea_type"),
				 ProinsoPackage.Literals.TAREA__CODIGO_COMPLETO,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCodigoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tarea_codigo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tarea_codigo_feature", "_UI_Tarea_type"),
				 ProinsoPackage.Literals.TAREA__CODIGO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProinsoPackage.Literals.TAREA__NOMBRE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProinsoPackage.Literals.TAREA__FLUJOS);
			childrenFeatures.add(ProinsoPackage.Literals.TAREA__PARTICIPACIONES);
			childrenFeatures.add(ProinsoPackage.Literals.TAREA__USO_PRACTICAS);
			childrenFeatures.add(ProinsoPackage.Literals.TAREA__USO_TECNICAS);
		}
	...
	public String getText(Object object) {
		String label = ((Tarea)object).getCodigoYNombre();
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProinsoPackage.Literals.TAREA__FLUJOS,
				 ProinsoFactory.eINSTANCE.createEntrada()));

		newChildDescriptors.add
			(createChildParameter
				(ProinsoPackage.Literals.TAREA__FLUJOS,
				 ProinsoFactory.eINSTANCE.createSalida()));

		newChildDescriptors.add
			(createChildParameter
				(ProinsoPackage.Literals.TAREA__PARTICIPACIONES,
				 ProinsoFactory.eINSTANCE.createParticipacion()));

		newChildDescriptors.add
			(createChildParameter
				(ProinsoPackage.Literals.TAREA__USO_PRACTICAS,
				 ProinsoFactory.eINSTANCE.createUsoPractica()));

		newChildDescriptors.add
			(createChildParameter
				(ProinsoPackage.Literals.TAREA__USO_TECNICAS,
				 ProinsoFactory.eINSTANCE.createUsoTecnica()));
	}
