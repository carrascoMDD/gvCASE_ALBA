...
/**
 * This is the item provider adapter for a {@link es.gva.cit.gvmetrica.orgcasi.Sistema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SistemaItemProvider
	 ...
	 * @generated
	 */
	public SistemaItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sistema_procedimiento_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sistema_procedimiento_feature", "_UI_Sistema_type"),
				 OrgcasiPackage.Literals.SISTEMA__PROCEDIMIENTO,
				 false,
				 false,
				 false,
				 null,
	...
	protected void addTodosSucesosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sistema_todosSucesos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sistema_todosSucesos_feature", "_UI_Sistema_type"),
				 OrgcasiPackage.Literals.SISTEMA__TODOS_SUCESOS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTodosSubsistemasPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sistema_todosSubsistemas_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sistema_todosSubsistemas_feature", "_UI_Sistema_type"),
				 OrgcasiPackage.Literals.SISTEMA__TODOS_SUBSISTEMAS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns Sistema.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Sistema"));
	}
	...
	public String getText(Object object) {
		String label = ((Sistema)object).getEtiqueta();
		return label == null || label.length() == 0 ?
			getString("_UI_Sistema_type") :
			getString("_UI_Sistema_type") + " " + label;
	}
