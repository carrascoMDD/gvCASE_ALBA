...
/**
 * This is the item provider adapter for a {@link es.gva.cit.gvmetrica.orgcasi.Salida} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SalidaItemProvider
	...
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDestinosPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Destinos feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDestinosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(
			new OCLCandidatesItemPropertyDescriptor			
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Salida_destinos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Salida_destinos_feature", "_UI_Salida_type"),
				 OrgcasiPackage.Literals.SALIDA__DESTINOS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OrgcasiPackage.Literals.SALIDA__DESTINOS);
		}
	...
	public String getText(Object object) {
		String label = ((Salida)object).getNombre();
