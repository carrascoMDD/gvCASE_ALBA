...
/**
 * This is the item provider adapter for a {@link es.gva.cit.gvcase.prototipo.rdbms.ConModelClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RdbmsPackage.Literals.CON_MODEL_CLASS__MODEL_CLASS,
				 false,
				 false,
				 false,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			if (fGetPrefShowMetamodelClassChildNode()) {
				childrenFeatures.add(RdbmsPackage.Literals.CON_MODEL_CLASS__MODEL_CLASS);
			}
		}
