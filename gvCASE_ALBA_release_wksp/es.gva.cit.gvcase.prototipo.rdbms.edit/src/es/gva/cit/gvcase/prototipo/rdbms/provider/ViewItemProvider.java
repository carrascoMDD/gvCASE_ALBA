...
/**
 * This is the item provider adapter for a {@link es.gva.cit.gvcase.prototipo.rdbms.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider
		...
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_etiqueta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_etiqueta_feature", "_UI_View_type"),
				 RdbmsPackage.Literals.VIEW__ETIQUETA,
				 false,
				 false,
				 false,
	...
	protected void addTablesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_tables_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_tables_feature", "_UI_View_type"),
				 RdbmsPackage.Literals.VIEW__TABLES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addWhereClausePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_whereClause_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_whereClause_feature", "_UI_View_type"),
				 RdbmsPackage.Literals.VIEW__WHERE_CLAUSE,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RdbmsPackage.Literals.VIEW__VIEW_COLUMNS);
			childrenFeatures.add(RdbmsPackage.Literals.VIEW__JOINS);
		}
	...
	public String getText(Object object) {
		String label = ((View)object).getEtiqueta();
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RdbmsPackage.Literals.VIEW__VIEW_COLUMNS,
				 RdbmsFactory.eINSTANCE.createViewColumn()));

		newChildDescriptors.add
			(createChildParameter
				(RdbmsPackage.Literals.VIEW__JOINS,
				 RdbmsFactory.eINSTANCE.createJoin()));
	}
