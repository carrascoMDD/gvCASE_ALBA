package es.gva.cit.gvcase.prototipo.rdbms.preferences;
...
import es.gva.cit.gvcase.prototipo.rdbms.presentation.RdbmsEditorPlugin;
...
public class RdbmsTreePreferences extends FieldEditorPreferencePage
	implements IWorkbenchPreferencePage {


    public RdbmsTreePreferences()
    {
        super(1);
        vShowMetamodelPackageChildNode = null;
        vShowMetamodelClassChildNode = null;
        
        setPreferenceStore(RdbmsEditorPlugin.getPlugin().getPreferenceStore());
        setDescription("Rdbms Tree Preferences Page");
        initializeDefaults();
    }
    ...
    private void updateEditPlugin( IPreferenceStore theStore) {
    	Map aEditPluginMap = RdbmsEditPlugin.getPlugin().getPreferencesMap();
