 ...
 * <ul>
 *   <li>{@link es.gva.cit.gvmetrica.orgcasi.impl.RolImpl#getEtiqueta <em>Etiqueta</em>}</li>
 *   <li>{@link es.gva.cit.gvmetrica.orgcasi.impl.RolImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link es.gva.cit.gvmetrica.orgcasi.impl.RolImpl#getComentario <em>Comentario</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class RolImpl extends OrgcasiObjectImpl implements Rol {
	/**
	...
	protected EClass eStaticClass() {
		return OrgcasiPackage.Literals.ROL;
	}
...
//		if (etiquetaDeriveOCL == null) { 
			EStructuralFeature eFeature = (EStructuralFeature) OrgcasiPackage.eINSTANCE.getRol().getEAllStructuralFeatures().get(1);
...
System.out.println(anException.getStackTrace());
			throw new RuntimeException( "Rol etiqueta", anException);
		}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrgcasiPackage.ROL__NOMBRE, oldNombre, nombre));
	}
	...
	public void setComentario(String newComentario) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrgcasiPackage.ROL__COMENTARIO, oldComentario, comentario));
	}
