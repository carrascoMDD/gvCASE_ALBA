...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>simapa</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SimapaExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(SimapaPackage.eNS_URI, 
			 SimapaPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.simapa"));
				Aplicacion root = SimapaFactory.eINSTANCE.createAplicacion();
