...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>orgcasi</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class OrgcasiExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(OrgcasiPackage.eNS_URI, 
			 OrgcasiPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.orgcasi"));
				AAplicacion root = OrgcasiFactory.eINSTANCE.createAAplicacion();
