 ...
 * <ul>
 *   <li>{@link es.gva.cit.gvmetrica.proinso.impl.ProcesoImpl#getDocumentacion <em>Documentacion</em>}</li>
 *   <li>{@link es.gva.cit.gvmetrica.proinso.impl.ProcesoImpl#getReferencias <em>Referencias</em>}</li>
 *   <li>{@link es.gva.cit.gvmetrica.proinso.impl.ProcesoImpl#getCodigoYNombre <em>Codigo YNombre</em>}</li>
 *   <li>{@link es.gva.cit.gvmetrica.proinso.impl.ProcesoImpl#getCodigo <em>Codigo</em>}</li>
 *   <li>{@link es.gva.cit.gvmetrica.proinso.impl.ProcesoImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link es.gva.cit.gvmetrica.proinso.impl.ProcesoImpl#getActividades <em>Actividades</em>}</li>
 *   <li>{@link es.gva.cit.gvmetrica.proinso.impl.ProcesoImpl#getProcesos <em>Procesos</em>}</li>
 *   <li>{@link es.gva.cit.gvmetrica.proinso.impl.ProcesoImpl#getCodigoCompleto <em>Codigo Completo</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ProcesoImpl extends ProinsoObjectImpl implements Proceso {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return ProinsoPackage.Literals.PROCESO;
	}
	...
	public NotificationChain basicSetDocumentacion(Documentacion newDocumentacion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProinsoPackage.PROCESO__DOCUMENTACION, oldDocumentacion, newDocumentacion);
	...
	public void setDocumentacion(Documentacion newDocumentacion) {
		if (newDocumentacion != documentacion) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ProinsoPackage.PROCESO__DOCUMENTACION, newDocumentacion, newDocumentacion));
	}
	...
	public EList getReferencias() {
		if (referencias == null) {
			referencias = new EObjectWithInverseResolvingEList(ReferenceRun.class, this, ProinsoPackage.PROCESO__REFERENCIAS, ProinsoPackage.REFERENCE_RUN__REFERENCIADO);
		}
		return referencias;
	}
...
//		if (codigoYNombreDeriveOCL == null) { 
			EStructuralFeature eFeature = (EStructuralFeature) ProinsoPackage.eINSTANCE.getProceso().getEAllStructuralFeatures().get(3);
...
System.out.println(anException.getStackTrace());
			throw new RuntimeException( "Proceso codigoYNombre", anException);
		}
	...
	public void setCodigo(String newCodigo) {
		...
		codigo = newCodigo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProinsoPackage.PROCESO__CODIGO, oldCodigo, codigo));
	}
	...
	public void setNombre(String newNombre) {
		...
		nombre = newNombre;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProinsoPackage.PROCESO__NOMBRE, oldNombre, nombre));
	}
	...
	public EList getActividades() {
		if (actividades == null) {
			actividades = new EObjectContainmentWithInverseEList(Actividad.class, this, ProinsoPackage.PROCESO__ACTIVIDADES, ProinsoPackage.ACTIVIDAD__PROCESO);
		}
		return actividades;
	}
	...
	public Procesos getProcesos() {
		if (eContainerFeatureID != ProinsoPackage.PROCESO__PROCESOS) return null;
		return (Procesos)eContainer();
	}
...
//		if (codigoCompletoDeriveOCL == null) { 
			EStructuralFeature eFeature = (EStructuralFeature) ProinsoPackage.eINSTANCE.getProceso().getEAllStructuralFeatures().get(8);
...
System.out.println(anException.getLocalizedMessage());
System.out.println(anException.getStackTrace());
			throw new RuntimeException( "Proceso codigoCompleto", anException);
		}
				...
				theDiagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ProinsoValidator.PROCESO__NOMBRE_VALIDAR,
			...
			if (theDiagnostics != null) {
				theDiagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ProinsoValidator.DIAGNOSTIC_SOURCE,
						 ProinsoValidator.PROCESO__CODIGO_VALIDAR,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProinsoPackage.PROCESO__DOCUMENTACION:
				if (documentacion != null)
					msgs = ((InternalEObject)documentacion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProinsoPackage.PROCESO__DOCUMENTACION, null, msgs);
				return basicSetDocumentacion((Documentacion)otherEnd, msgs);
			case ProinsoPackage.PROCESO__REFERENCIAS:
			...
			case ProinsoPackage.PROCESO__PROCESOS:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return eBasicSetContainer(otherEnd, ProinsoPackage.PROCESO__PROCESOS, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ProinsoPackage.PROCESO__PROCESOS:
				return eBasicSetContainer(null, ProinsoPackage.PROCESO__PROCESOS, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case ProinsoPackage.PROCESO__PROCESOS:
				return eInternalContainer().eInverseRemove(this, ProinsoPackage.PROCESOS__PROCESOS, Procesos.class, msgs);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class baseClass) {
		if (baseClass == ConDocumentacion.class) {
			switch (derivedFeatureID) {
				case ProinsoPackage.PROCESO__DOCUMENTACION: return ProinsoPackage.CON_DOCUMENTACION__DOCUMENTACION;
				default: return -1;
			}
		}
		if (baseClass == Referenciable.class) {
			switch (derivedFeatureID) {
				case ProinsoPackage.PROCESO__REFERENCIAS: return ProinsoPackage.REFERENCIABLE__REFERENCIAS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass) {
		if (baseClass == ConDocumentacion.class) {
			switch (baseFeatureID) {
				case ProinsoPackage.CON_DOCUMENTACION__DOCUMENTACION: return ProinsoPackage.PROCESO__DOCUMENTACION;
				default: return -1;
			}
		}
		if (baseClass == Referenciable.class) {
			switch (baseFeatureID) {
				case ProinsoPackage.REFERENCIABLE__REFERENCIAS: return ProinsoPackage.PROCESO__REFERENCIAS;
				default: return -1;
			}
		}
